...
### Bootstrap → _Component-first_ (componentes prontos)
...
### Tailwind → _Utility-first_ (utilitários primeiro)
...
> ⚠️ Em **produção**, o Tailwind é instalado via npm com um passo de _build_ que
